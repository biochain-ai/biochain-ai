...
function startWebServer() {
    ...
    docker run -d --net biochain-ai_fabric-network --env GOOGLE_OAUTH_CLIENT_ID_TEST_CHAINCODE --env GOOGLE_OAUTH_CLIENT_SECRET_TEST_CHAINCODE -p 8080:80 -p 443:443 --name web-server-php web-server-php
}
